    ...
    <>
      ...
      >
        ...
        <nav className="p-5 space-y-1.5 mt-4">
          ...
          <button
            className={itemClass('subcategories')}
          ...
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h14a2 2 0 012 2v12a4 4 0 01-4 4h-2m-6 0h6m-6 0v-4m6 4v-4m-6 0H5m6 0h6"
              />
            </svg>
            Coupons
          </button>
          ...
          <button
            className={itemClass('bxgy')}
            onClick={() => handleNavigate('/admin/bxgy')}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                strokeWidth="2"
                d="M12 8v8m4-4H8m12 0a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2v-6a2 2 0 012-2h16z"
              />
            </svg>
            BXGY Coupons
          </button>
          ...
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.966a1 1 0 00.95.69h4.176c.969 0 1.371 1.24.588 1.81l-3.38 2.455a1 1 0 00-.364 1.118l1.287 3.966c.3.921-.755 1.688-1.54 1.118l-3.38-2.455c-.784-.57-1.838-.197-1.539-1.118l1.286-3.966a1 1 0 00-.364-1.118L2.98 9.393c-.783-.57-.38-1.81.588-1.81h4.176a1 1 0 00.95-.69l1.355-3.966z"
              />
            </svg>
            Reviews
          </button>
          ...
          <button
            className={itemClass('faqs')}
            onClick={() => handleNavigate('/admin/faqs')}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
          ...
          <button
            className={itemClass('productaddons')}
            onClick={() => handleNavigate('/admin/productaddons')}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                strokeWidth="2"
                d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.77 8 0 01-4-.8L3 20l1.2-3.6A7.96 7.96 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"
              />
            </svg>
            Product Addons
          </button>
          ...
          <button
            ...
            className="
              ...
              hover:from-gray-800
              hover:to-gray-900
              dark:hover:from-gray-200
              dark:hover:to-gray-100
              transition-all
              duration-300
              shadow-md
              hover:shadow-lg
      ...
      <aside className="hidden md:block w-72 bg-white dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800 shadow-xl fixed top-0 bottom-0 left-0 z-40 overflow-y-auto animate-slideIn">
        ...
        <nav className="p-5 space-y-1.5 mt-4">
          ...
          <button className={itemClass('reviews')} onClick={() => navigate('/admin/reviews')}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <button className={itemClass('faqs')} onClick={() => navigate('/admin/faqs')}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <button className={itemClass('productaddons')} onClick={() => navigate('/admin/productaddons')}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
